...
public class BlueDuck extends Duck {
    ...
    /**
     * Constructs a BlueDuck object with the specified initial position and velocities.
     *
     * @param x The initial x position of the BlueDuck.
     * @param y The initial y position of the BlueDuck.
     * @param xVelocity The initial velocity in the x direction.
     * @param yVelocity The initial velocity in the y direction.
     */
    public BlueDuck(double x,double y, double xVelocity,double yVelocity){
    ...
    /**
     * Moves the BlueDuck using the first type of movement.
     *
     * @param root The root pane where the BlueDuck is displayed.
     */
    ...
    /**
     * Moves the BlueDuck using the second type of movement.
     *
     * @param root The root pane where the BlueDuck is displayed.
     */
    ...
    /**
     * Updates the position of the BlueDuck using the second type of movement.
     *
     * @param root The root pane where the BlueDuck is displayed.
     */
    ...
    /**
     * Handles the mouse click event on the BlueDuck.
     *
    ...
    /**
     * Starts the falling animation of the BlueDuck.
     *
     * @param root The root pane where the BlueDuck is displayed.
     */
    ...
    /**
     * Sets the shot status of the BlueDuck.
     *
    ...
    /**
     * Checks if the BlueDuck is shot.
     *
