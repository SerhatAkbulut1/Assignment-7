...
public class Level1 {
    ...
    RedDuck redDuck = new RedDuck(25,25 , 5, -5);
     ...
     */
    public Level1( Image background, Image foreground, Image crosshairImage) {
    ...
    private void initializeCrosshair() {
        ...
        levelPane.setOnMouseClicked(event -> {
            ...
            if (bullets == 0 && deadDucks.size() < 1) {
                statusText.setText("GAME OVER!");
                statusText2.setText("Press ENTER to play again\n\t Press ESC to exit");
                statusText.toFront();
                statusText2.toFront();
                DuckHunt.level1Complate = false;
            ...
            } else if (bullets >=0 && deadDucks.size()==1) {
                statusText.setText("    YOU WIN!");
                statusText2.setText("Press ENTER to play next level");
                statusText.toFront();
                statusText2.toFront();
                levelComplate = true;
                DuckHunt.level1Complate = true;
